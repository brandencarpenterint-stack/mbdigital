const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-D19LzJjy.js","assets/index-Crwj5ZRh.js","assets/index-CvR-T87U.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-Crwj5ZRh.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-D19LzJjy.js");
