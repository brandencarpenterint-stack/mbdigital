const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-1OpB6Gbp.js","assets/index-I_jIDthF.js","assets/index-BlbmCFba.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, b as useGamification, D as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-I_jIDthF.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-1OpB6Gbp.js");
