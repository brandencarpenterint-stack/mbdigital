import { a as useGamification, c as useToast, b as useRetroSound, r as reactExports, j as jsxRuntimeExports, L as Link, S as SquishyButton } from "./index-BF7Bb9kP.js";
...
const MerchLab = () => {
  ...
  const handleShare = async () => {
    ...
    if (canvasRef.current) {
      try {
        showToast("Capturing Design...", "info");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flex: 1, height: "calc(100vh - 80px)", overflow: "hidden" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "250px", background: "#181818", borderLeft: "1px solid #333", padding: "15px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "auto", paddingTop: "20px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SquishyButton, { onClick: handleShare, style: { width: "100%", background: "linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)" }, children: "📸 SHARE TO IG" }) }),
