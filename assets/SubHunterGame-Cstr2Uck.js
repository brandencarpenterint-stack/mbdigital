const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService--2STAFjM.js","assets/index-DQ4hlJ1c.js","assets/index-VoOCLcSk.css"])))=>i.map(i=>d[i]);
import { z as useNavigate, r as reactExports, b as useGamification, B as useInventory, x as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-DQ4hlJ1c.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService--2STAFjM.js");
