import { r as reactExports, j as jsxRuntimeExports, S as SquishyButton, a as useGamification, c as useToast, b as useRetroSound, t as triggerConfetti } from "./index-BjlAyyZi.js";
const hexToRgb = (hex) => {
...
const ColoringCanvas = ({ templateImage, onComplete, hasPremiumStamps }) => {
  ...
  const [selectedSticker, setSelectedSticker] = reactExports.useState(allStickers[0]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "20px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        SquishyButton,
        {
          onClick: () => {
            setColor(c);
            setTool((prev) => prev === "eraser" ? "bucket" : prev);
          },
          style: {
            width: "30px",
            height: "30px",
    ...
    tool === "sticker" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      ...
      maxWidth: "100%",
      overflowX: "auto"
    }, children: allStickers.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
...
const Coloring = () => {
  ...
  const [hasPremiumStamps, setHasPremiumStamps] = reactExports.useState(localStorage.getItem("unlockedColoringStamps") === "true");
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", style: {
    ...
    !selectedTemplate ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px", marginBottom: "20px" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "20px", justifyContent: "center", marginTop: "10px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#aaa", fontSize: "0.9rem", margin: 0 }, children: [
            "WALLET: ",
      ...
      !hasPremiumStamps && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxWidth: "1000px", margin: "0 auto 30px auto", padding: "0 20px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-panel", style: {
        padding: "20px",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "left", flex: 1, minWidth: "250px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { margin: 0, color: "var(--neon-gold)", fontSize: "1.5rem", textShadow: "0 0 10px rgba(255,215,0,0.5)" }, children: "⭐ PREMIUM STAMP PACK" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: "5px 0 0 0", color: "#ccc", fontSize: "0.9rem" }, children: "Unlock 50+ custom adorable stamps for your masterpieces! Aliens, dinosaurs, magical items, and more!" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SquishyButton, { onClick: handlePurchaseStamps, style: {
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                ...
                fontSize: "0.8rem",
                fontWeight: "bold"
              }, children: isOwned ? "OWNED" : template.type === "time" ? `⏱️ ${template.unlockTime} MINS` : `🪙 ${template.cost}` })
            ]
          },
          template.id
        );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-panel", style: { padding: "20px", display: "inline-block", maxWidth: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ColoringCanvas, { templateImage: selectedTemplate.src, hasPremiumStamps }) })
    ] }),
