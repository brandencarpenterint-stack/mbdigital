const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-DS3wm4Sj.js","assets/index-D2I7bPAo.js","assets/index-Cn7Sh0og.css"])))=>i.map(i=>d[i]);
import { z as useNavigate, r as reactExports, b as useGamification, B as useInventory, x as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-D2I7bPAo.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-DS3wm4Sj.js");
