import { a as useGamification, r as reactExports, s as supabase, j as jsxRuntimeExports, b as useRetroSound, u as usePocketBro, c as useToast, A as AnimatePresence, m as motion, L as Link, P as PocketPet } from "./index-BjlAyyZi.js";
import { feedService } from "./feed-wqkKonIQ.js";
import { L as LeaderboardTable } from "./LeaderboardTable-D_OBOlxv.js";
import { T as TiltCard } from "./TiltCard-_kxb9xtS.js";
/* empty css              */
import "./LeaderboardService-BJBOzmet.js";
import "./use-transform-CQVuJcuy.js";
import "./use-spring-D5fEixov.js";
const LiveFeed = () => {
  ...
  reactExports.useEffect(() => {
    const fetchOnline = async () => {
      ...
      if (supabase) {
        ...
        const { data } = await supabase.from("profiles").select("display_name, avatar_url, coins, last_seen").gt("last_seen", fifteenMinsAgo).order("last_seen", { ascending: false }).limit(20);
        if (data) {
          users = data.map((u) => ({
            ...u,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          games.map((game) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: game.path || `/arcade/${game.id}`, style: { textDecoration: "none", WebkitTapHighlightColor: "transparent" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ArcadeCabinet,
                {
                  game,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, style: { height: "100%", gridColumn: "span 1", display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TheButton, {}) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
