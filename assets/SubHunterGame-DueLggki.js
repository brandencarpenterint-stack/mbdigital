const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-AF7Fts_8.js","assets/index-Dbaofx5w.js","assets/index-CvR-T87U.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, D as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-Dbaofx5w.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-AF7Fts_8.js");
