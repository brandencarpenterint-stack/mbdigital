import { z as useNavigate, c as useRetroSound, b as useGamification, r as reactExports, j as jsxRuntimeExports, S as SquishyButton } from "./index-B57dY8vj.js";
const GRAVITY = 0.5;
const GROUND_LEVEL = 50;
const BroCannon = () => {
  const navigate = useNavigate();
  const { playJump, playBoop, playCrash, playWin } = useRetroSound();
