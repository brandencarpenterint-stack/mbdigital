const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-CS1HuFAs.js","assets/index-BF7Bb9kP.js","assets/index-BDvmBGas.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, D as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-BF7Bb9kP.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-CS1HuFAs.js");
