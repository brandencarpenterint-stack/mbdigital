import { a as useGamification, r as reactExports, j as jsxRuntimeExports, d as STICKER_COLLECTIONS, S as SquishyButton, u as usePocketBro, b as useRetroSound, e as SHOP_ITEMS, C as CATEGORIES, m as motion, A as AnimatePresence, f as ACHIEVEMENTS, t as triggerConfetti, L as Link } from "./index-DjiG_brn.js";
import { S as StickerSprite } from "./StickerSprite-C9ejiOW7.js";
import { u as useMotionValue, a as useTransform } from "./use-transform-DXkdcG9J.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", overflowY: "auto", padding: "20px" }, children: [
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "30px", background: "rgba(255,255,255,0.05)", padding: "15px", borderRadius: "15px" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "15px", flexWrap: "wrap" }, children: col.items.map((item) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", marginBottom: "5px", display: "flex", alignItems: "center", justifyContent: "center", width: "100%", height: "60px" }, children: item.sheet || col.sheet ? /* @__PURE__ */ jsxRuntimeExports.jsx(StickerSprite, { sticker: item, size: 60 }) : item.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.image, style: { maxHeight: "100%", maxWidth: "100%", objectFit: "contain" } }) : item.icon }),
        ...
        view === "MACHINE" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", position: "relative" }, children: animationState === "REVEAL" && reward ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal-anim", style: { animation: "popIn 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...
            width: "200px",
            height: "200px"
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "6rem", display: "flex", alignItems: "center", justifyContent: "center", width: "100%", height: "100%" }, children: reward.sheet || STICKER_COLLECTIONS.find((c) => c.items.some((i) => i.id === reward.id))?.sheet ? /* @__PURE__ */ jsxRuntimeExports.jsx(StickerSprite, { sticker: reward, size: 150 }) : reward.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: reward.image, style: { maxHeight: "80%", maxWidth: "80%", objectFit: "contain", filter: "drop-shadow(0 0 20px rgba(255,255,255,0.5))" } }) : reward.icon }) }),
...
const BLACK_MARKET_ITEMS = [
  {
    id: "void_egg",
    name: "VOID EGG",
    description: "A cold, vibrating egg from the dark web. Hatches a Ghost Type.",
    price: 6666,
    icon: "🥚",
    type: "consumable",
    effect: "transform_ghost"
  },
  {
    id: "glitch_brew",
    name: "GLITCH BREW",
    description: "Drink at your own risk. Randomtains stats.",
    price: 999,
    icon: "🧪",
    type: "consumable",
    effect: "random_stats"
  },
  {
    id: "miner_chip",
    name: "CRYPTO MINER",
    description: "Install in your room to passively mine coins.",
    price: 5e3,
    icon: "💾",
    type: "decor",
    effect: "mine_coins"
...
const BlackMarketModal = ({ onClose }) => {
  ...
  const [msg, setMsg] = reactExports.useState("NO REFUNDS. NO QUESTIONS.");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SquishyButton, { onClick: onClose, style: { position: "absolute", top: 10, right: 10, background: "red", color: "black" }, children: "X" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { color: "#0f0", textAlign: "center", borderBottom: "1px solid #0f0", paddingBottom: "10px", textShadow: "2px 2px 0 #005500" }, children: "/// BLACK_MARKET_V9 ///" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "#0f0", textAlign: "center", margin: "20px 0", background: "#002200", padding: "10px" }, children: [
        ">> ",
        msg,
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "blink", children: "_" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gap: "15px" }, children: BLACK_MARKET_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        display: "flex",
        alignItems: "center",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, padding: "0 20px", color: "#0f0" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: "bold" }, children: item.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.8rem", opacity: 0.7 }, children: item.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "20px", fontSize: "0.7rem", color: "#0f0", textAlign: "center", opacity: 0.5 }, children: "CONNECTION ENCRYPTED via ONION_ROUTER_7" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
...
const ShopPage = () => {
  ...
  const [showBlackMarket, setShowBlackMarket] = reactExports.useState(false);
  const { playBeep, playCollect, playBoop } = useRetroSound();
  const isNight = (/* @__PURE__ */ new Date()).getHours() >= 22 || (/* @__PURE__ */ new Date()).getHours() < 4;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", style: { minHeight: "100vh", paddingBottom: "120px", background: "radial-gradient(circle at top, #1a202c, #000)", fontFamily: '"Rajdhani", sans-serif' }, children: [
    ...
    showBlackMarket && /* @__PURE__ */ jsxRuntimeExports.jsx(BlackMarketModal, { onClose: () => setShowBlackMarket(false) }),
    canSeeBlackMarket && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
