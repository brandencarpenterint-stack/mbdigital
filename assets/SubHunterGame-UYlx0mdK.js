const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-CxSVvRxX.js","assets/index-lpJcWyh7.js","assets/index-VoOCLcSk.css"])))=>i.map(i=>d[i]);
import { z as useNavigate, r as reactExports, b as useGamification, B as useInventory, x as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-lpJcWyh7.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-CxSVvRxX.js");
