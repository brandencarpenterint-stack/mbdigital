const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-CIQFoCpn.js","assets/index-DYcDl0OM.js","assets/index-BDvmBGas.css"])))=>i.map(i=>d[i]);
import { z as useNavigate, r as reactExports, a as useGamification, B as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-DYcDl0OM.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-CIQFoCpn.js");
