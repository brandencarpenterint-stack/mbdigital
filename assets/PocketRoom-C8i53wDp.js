import { u as usePocketBro, j as jsxRuntimeExports } from "./index-CfmL3Xs0.js";
const DECOR_ITEMS = [
  // --- BACKGROUNDS ---
  {
    id: "bg_cyber",
...
const PocketRoom = ({ isEditing, selectedItem, onPlace, customItems, petComponent }) => {
  ...
  const handleCellClick = (x, y) => {
    if (!isEditing) {
      const existing2 = getItemAt(x, y);
      if (existing2) {
        interactWithItem(existing2.id);
      }
      return;
    }
    if (x === 2 && y === 2) return;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              isCenter && petComponent && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, zIndex: 5, pointerEvents: "none" }, children: petComponent }),
