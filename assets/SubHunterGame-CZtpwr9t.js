const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-BJBOzmet.js","assets/index-BjlAyyZi.js","assets/index-BlbmCFba.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-BjlAyyZi.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-BJBOzmet.js");
