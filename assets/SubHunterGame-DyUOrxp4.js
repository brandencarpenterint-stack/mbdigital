const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService--f4sdH57.js","assets/index-DEVoZ6jg.js","assets/index-BDvmBGas.css"])))=>i.map(i=>d[i]);
import { z as useNavigate, r as reactExports, a as useGamification, B as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-DEVoZ6jg.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService--f4sdH57.js");
