import { b as useGamification, a as usePocketBro, g as useToast, r as reactExports, j as jsxRuntimeExports, t as triggerConfetti, e as SHOP_ITEMS, P as PocketPet, S as SquishyButton, h as POCKET_BRO_STAGES, i as ADVENTURE_LOCATIONS } from "./index-DNJ_Vni_.js";
import { D as DECOR_ITEMS, P as PocketRoom } from "./PocketRoom-CWCKDbUT.js";
...
const BattleArenaModal = ({ onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    battleState === "LOBBY" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gap: "15px" }, children: [
      BOTS.map((bot, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => startBattle(i), style: {
        padding: "15px",
        background: "#222",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "red" }, children: [
          "⚔️ ",
          bot.atk
        ] })
      ] }, i)),
    ...
    battleState === "FIGHT" && opponent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%", maxWidth: "500px", textAlign: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "40px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", gap: "20px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { transform: "scale(0.8)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "4rem" }, children: opponent.type === "SOOT" ? "🌑" : opponent.type === "SLIME" ? "🟢" : opponent.type === "ROBOT" ? "🤖" : opponent.type === "DINO" ? "🦖" : "👽" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "40px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", gap: "20px", flexDirection: "row-reverse" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { transform: "scale(1.2)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PocketPet, { type: stats.type, stage: stats.stage, mood: "happy" }) }),
