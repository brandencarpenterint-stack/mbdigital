import { b as useGamification, D as useNotifications, u as useSquad, E as useTheme, c as useRetroSound, g as useToast, a as usePocketBro, r as reactExports, j as jsxRuntimeExports, S as SquishyButton, A as AnimatePresence, m as motion, f as ACHIEVEMENTS, t as triggerConfetti, s as supabase } from "./index-BtL-ywO7.js";
import { feedService } from "./feed-CEv6qHCi.js";
import { P as PocketRoom, D as DECOR_ITEMS } from "./PocketRoom-B9Ktxxcg.js";
const AVATARS = [
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column" }, children: [
            ...
            !isRoomEditing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "20px", background: "rgba(0,0,0,0.3)", padding: "15px", borderRadius: "15px", border: "1px solid #333" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { style: { margin: "0 0 10px 0", fontSize: "1rem", color: "#ff0055", letterSpacing: "2px", display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                ...
                isReadOnly && /* @__PURE__ */ jsxRuntimeExports.jsx(SquishyButton, { onClick: () => {
                  const emoji = ["🔥", "👾", "👽", "❤️", "💩", "👑"][Math.floor(Math.random() * 6)];
                  handleSignGuestbook(emoji);
                }, style: { fontSize: "0.7rem", padding: "5px 10px", background: "#ff0055" }, children: "SIGN LOG" })
              ] }),
