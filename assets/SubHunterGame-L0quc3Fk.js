const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-kVtPh7Ae.js","assets/index-1m1nRMjW.js","assets/index-CvR-T87U.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-1m1nRMjW.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-kVtPh7Ae.js");
