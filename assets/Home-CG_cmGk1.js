import { u as usePocketBro, a as useGamification, b as useRetroSound, r as reactExports, c as useToast, j as jsxRuntimeExports, m as motion, L as Link } from "./index-W_tBu39q.js";
/* empty css              */
import { T as TiltCard } from "./TiltCard-BbYYUZZ2.js";
import "./use-transform-CnlL7WPD.js";
import "./use-spring-BbaC6gi3.js";
const container = {
  hidden: { opacity: 0 },
  show: {
    opacity: 1,
...
const Home = () => {
  ...
  const [ticker, setTicker] = reactExports.useState("MCH: $102.30 ▲ | DOG: $0.44 ▼ | VOD: $666.00 ▲ | GLT: $49.20 ▲");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-panel", style: { flex: 1, height: "100%", overflow: "hidden", display: "flex", alignItems: "center", position: "relative" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { whiteSpace: "nowrap", animation: "ticker 20s linear infinite", position: "absolute", width: "100%", color: "#aaa", fontSize: "0.9rem", fontFamily: "monospace" }, children: [
            "SYSTEM_STATUS: ONLINE // ",
            ticker,
            " // NEW MERCH DROPPED // ACTIVE USERS: ",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, onMouseEnter: playBeep, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TiltCard, { className: "bento-card", style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "20px", transform: "translateZ(10px)" }, children: dailyState?.quests?.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, textDecoration: q.claimed ? "line-through" : "none", color: "#ddd" }, children: q.text })
            ] }, q.id)) })
          ] }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/bro-finder", style: { textDecoration: "none", color: "inherit", display: "block" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, onMouseEnter: playBeep, style: { height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TiltCard, { className: "bento-card", style: {
            ...
            color: "white",
            padding: "20px"
          }, glowColor: "rgba(255,0,255,0.4)", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", transform: "translateZ(30px)" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "4rem", marginBottom: "10px" }, children: "🔥" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: 0, fontSize: "2rem", fontStyle: "italic" }, children: "BroFinder" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { opacity: 0.8, fontSize: "0.8rem" }, children: "RECRUIT SQUAD MEMBERS" })
          ] }) }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/arena", style: { textDecoration: "none", color: "inherit", gridColumn: "span 2", display: "block" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, onMouseEnter: playBeep, style: { height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TiltCard, { className: "bento-card", style: {
            background: "linear-gradient(to right, #9d00ff 0%, #ff0055 100%)",
            display: "flex",
            alignItems: "center",
            padding: "40px",
            position: "relative"
          }, glowColor: "rgba(255,0,0,0.5)", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { zIndex: 10, maxWidth: "50%", transform: "translateZ(30px)" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { background: "white", color: "#ff0055", padding: "5px 10px", borderRadius: "4px", fontWeight: "bold", fontSize: "0.8rem" }, children: "NEW RELEASE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { fontSize: "3rem", margin: "15px 0", textShadow: "0 5px 10px rgba(0,0,0,0.2)" }, children: "GLITCH ARENA" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: 0, fontWeight: "bold", opacity: 0.9 }, children: "IDLE SQUAD BATTLER" }),
              ...
              }, children: "ENTER COMBAT ▶" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", right: "50px", top: "50%", transform: "translateY(-50%) translateZ(50px)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "8rem", filter: "drop-shadow(0 20px 30px rgba(0,0,0,0.3))", transform: "rotate(15deg)" }, children: "⚔️" }) })
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/hustle", style: { textDecoration: "none", display: "block" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, onMouseEnter: playBeep, style: { height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TiltCard, { className: "bento-card", style: { background: "#222", color: "#fff", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-between" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { transform: "translateZ(10px)" }, children: [
              "HUSTLE MODE ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.7rem", color: "#888" }, children: "FOCUS TIMER" })
            ] })
          ] }) }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/exchange", style: { textDecoration: "none", display: "block" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, onMouseEnter: playBeep, style: { height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TiltCard, { className: "bento-card", style: { background: "#0a0a12", color: "#00ffcc", border: "1px solid #00ffcc", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-between" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", transform: "translateZ(20px)" }, children: "📉" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { transform: "translateZ(10px)" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                "MBX EXCHANGE",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.6rem", background: "#00ffcc", color: "black", padding: "2px 4px", borderRadius: "4px", fontWeight: "bold" }, children: "v2.0" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.7rem", opacity: 0.7 }, children: "CRYPTO" })
            ] })
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/terminal", style: { textDecoration: "none", display: "block" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item, onMouseEnter: playBeep, style: { height: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TiltCard, { className: "bento-card", style: { background: "#000", color: "#00ff00", border: "1px solid #00ff00", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-between" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", transform: "translateZ(20px)" }, children: "💻" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { transform: "translateZ(10px)" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
                "TERMINAL",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.6rem", background: "#00ff00", color: "black", padding: "2px 4px", borderRadius: "4px", fontWeight: "bold" }, children: "ROOT" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.7rem", opacity: 0.7 }, children: "ACCESS GRANTED" })
            ] })
          ] }) }) }),
