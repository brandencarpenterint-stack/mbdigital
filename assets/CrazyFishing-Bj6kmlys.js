import { r as reactExports, u as useGamification, a as useRetroSound, t as triggerConfetti, j as jsxRuntimeExports, L as Link, S as SquishyButton } from "./index-HnrdNYLo.js";
import { feedService } from "./feed-4jpFbd4y.js";
const BIOMES = [
...
const FISH_DATA = [
  // --- SURFACE (0-300m) ---
  { id: "boot", name: "Old Boot", score: 1, sheet: "surface", row: 0, col: 0, minDepth: 0, maxDepth: 300, pattern: "FLOAT", speed: 1, weight: [0.5, 2] },
  { id: "can", name: "Soda Can", score: 1, sheet: "surface", row: 0, col: 1, minDepth: 0, maxDepth: 300, pattern: "FLOAT", speed: 1, weight: [0.1, 0.5] },
  { id: "bottle", name: "Message", score: 5, sheet: "surface", row: 0, col: 2, minDepth: 0, maxDepth: 300, pattern: "FLOAT", speed: 0.5, weight: [1, 2] },
  { id: "wood", name: "Driftwood", score: 2, sheet: "surface", row: 0, col: 3, minDepth: 0, maxDepth: 300, pattern: "FLOAT", speed: 0.8, weight: [2, 10] },
  ...
  { id: "ducky", name: "Lost Duck", score: 10, sheet: "surface", row: 1, col: 2, minDepth: 0, maxDepth: 100, pattern: "FLOAT", speed: 0.5, weight: [0.5, 1] },
  { id: "sushi", name: "Runaway Sushi", score: 15, sheet: "surface", row: 1, col: 3, minDepth: 100, maxDepth: 350, pattern: "DART", speed: 3, weight: [0.1, 0.3] },
  // --- SEAGRASS (300-600m) ---
  { id: "crab", name: "Crabby", score: 8, sheet: "surface", row: 2, col: 0, minDepth: 300, maxDepth: 600, pattern: "DART", speed: 2, weight: [0.5, 3] },
  { id: "turtle", name: "Mr. Turtle", score: 25, sheet: "surface", row: 2, col: 1, minDepth: 300, maxDepth: 600, pattern: "FLOAT", speed: 0.8, weight: [10, 50] },
  ...
  { id: "snake", name: "Sea Snake", score: 18, sheet: "surface", row: 2, col: 3, minDepth: 400, maxDepth: 600, pattern: "SINE", speed: 3, weight: [1, 5] },
  { id: "eel", name: "Zappy Eel", score: 20, sheet: "surface", row: 3, col: 0, minDepth: 550, maxDepth: 700, pattern: "GLITCH", speed: 4, weight: [2, 8] },
  { id: "snail", name: "Gary", score: 6, sheet: "surface", row: 3, col: 1, minDepth: 300, maxDepth: 600, pattern: "FLOAT", speed: 0.2, weight: [0.1, 0.5] },
  { id: "cuke", name: "Sea Cucumber", score: 10, sheet: "surface", row: 3, col: 2, minDepth: 500, maxDepth: 600, pattern: "FLOAT", speed: 0.1, weight: [0.5, 1] },
  // --- CORAL (600-900m) ---
  ...
  { id: "clown", name: "Nemo", score: 15, sheet: "coral", row: 0, col: 1, minDepth: 600, maxDepth: 900, pattern: "DART", speed: 2, weight: [0.2, 0.8] },
  { id: "squid", name: "Squiddy", score: 20, sheet: "coral", row: 0, col: 2, minDepth: 650, maxDepth: 900, pattern: "DART", speed: 3, weight: [2, 15] },
  { id: "lobster", name: "Rock Lobster", score: 25, sheet: "coral", row: 0, col: 3, minDepth: 700, maxDepth: 900, pattern: "FLOAT", speed: 2, weight: [1, 5] },
  { id: "puffer", name: "Puff Daddy", score: 30, sheet: "coral", row: 1, col: 0, minDepth: 600, maxDepth: 900, pattern: "FLOAT", speed: 1, weight: [1, 4] },
  { id: "star", name: "Pat-Rock", score: 10, sheet: "coral", row: 1, col: 1, minDepth: 600, maxDepth: 900, pattern: "FLOAT", speed: 0.5, weight: [0.5, 2] },
  { id: "box", name: "Boxfish", score: 35, sheet: "coral", row: 1, col: 2, minDepth: 700, maxDepth: 900, pattern: "FLOAT", speed: 1, weight: [1, 2] },
  { id: "conch", name: "Magic Conch", score: 40, sheet: "coral", row: 1, col: 3, minDepth: 800, maxDepth: 900, pattern: "FLOAT", speed: 0, weight: [2, 5] },
  // --- TWILIGHT (900-1200m) ---
  { id: "jelly", name: "Jelly", score: 30, sheet: "coral", row: 2, col: 0, minDepth: 900, maxDepth: 1200, pattern: "FLOAT", speed: 0.5, weight: [1, 5] },
  { id: "stingray", name: "Flappy Ray", score: 40, sheet: "coral", row: 2, col: 1, minDepth: 950, maxDepth: 1200, pattern: "SINE", speed: 1.5, weight: [10, 40] },
  { id: "angler", name: "Lantern Fish", score: 45, sheet: "coral", row: 2, col: 2, minDepth: 1e3, maxDepth: 1200, pattern: "DART", speed: 3, weight: [5, 15] },
  { id: "sword", name: "Swordy", score: 50, sheet: "coral", row: 2, col: 3, minDepth: 1e3, maxDepth: 1200, pattern: "DART", speed: 5, weight: [50, 200] },
  ...
  { id: "flash", name: "Flashlight", score: 55, sheet: "coral", row: 3, col: 1, minDepth: 1e3, maxDepth: 1200, pattern: "DART", speed: 4, weight: [0.5, 1] },
  { id: "vamp", name: "Vampire Squid", score: 60, sheet: "coral", row: 3, col: 2, minDepth: 1100, maxDepth: 1200, pattern: "GLITCH", speed: 3, weight: [5, 10] },
  { id: "iso", name: "Giant Isopod", score: 90, sheet: "coral", row: 3, col: 3, minDepth: 1700, maxDepth: 1800, pattern: "FLOAT", speed: 1, weight: [1, 2] },
  // --- MIDNIGHT (1200-1500m) ---
  { id: "shark", name: "Sharky", score: 50, sheet: "deep", row: 0, col: 0, minDepth: 1200, maxDepth: 1500, pattern: "SINE", speed: 2, weight: [50, 300] },
  { id: "whale", name: "Whaley", score: 80, sheet: "deep", row: 0, col: 1, minDepth: 1200, maxDepth: 1500, pattern: "FLOAT", speed: 1, weight: [1e3, 5e3] },
  { id: "moon", name: "Moon Rock", score: 100, sheet: "deep", row: 0, col: 2, minDepth: 1300, maxDepth: 1500, pattern: "FLOAT", speed: 0.2, weight: [100, 200] },
  { id: "wolf", name: "Wolf Fish", score: 70, sheet: "deep", row: 0, col: 3, minDepth: 1200, maxDepth: 1500, pattern: "DART", speed: 3, weight: [10, 20] },
  { id: "sleep", name: "Sleeper Shark", score: 75, sheet: "deep", row: 1, col: 0, minDepth: 1400, maxDepth: 1500, pattern: "FLOAT", speed: 0.5, weight: [200, 400] },
  // --- TRENCH (1500-1800m) ---
  { id: "blob", name: "Blobfish", score: 70, sheet: "deep", row: 1, col: 1, minDepth: 1500, maxDepth: 1800, pattern: "FLOAT", speed: 0.5, weight: [5, 20] },
  { id: "worm", name: "Tube Worm", score: 60, sheet: "deep", row: 1, col: 2, minDepth: 1550, maxDepth: 1800, pattern: "FLOAT", speed: 0, weight: [1, 2] },
  { id: "viper", name: "Viperfish", score: 85, sheet: "deep", row: 1, col: 3, minDepth: 1600, maxDepth: 1800, pattern: "DART", speed: 5, weight: [2, 5] },
  // --- NEON CITY (1800-2100m) ---
  { id: "cyber", name: "Cyber Fish", score: 110, sheet: "deep", row: 2, col: 0, minDepth: 1800, maxDepth: 2100, pattern: "DART", speed: 5, weight: [2, 5] },
  { id: "robot", name: "Bot-01", score: 120, sheet: "deep", row: 2, col: 1, minDepth: 1850, maxDepth: 2100, pattern: "GLITCH", speed: 3, weight: [50, 100] },
  { id: "floppy", name: "Diskette", score: 50, sheet: "deep", row: 2, col: 2, minDepth: 1900, maxDepth: 2100, pattern: "FLOAT", speed: 0, weight: [0.1, 0.1] },
  { id: "batt", name: "Battery", score: 60, sheet: "deep", row: 2, col: 3, minDepth: 2e3, maxDepth: 2100, pattern: "FLOAT", speed: 0, weight: [0.2, 0.5] },
  // --- BONEYARD (2100-2400m) ---
  { id: "skull", name: "Bone Fish", score: 60, sheet: "deep", row: 3, col: 0, minDepth: 2100, maxDepth: 2400, pattern: "DART", speed: 3, weight: [5, 10] },
  { id: "fossil", name: "Trilobite", score: 80, sheet: "deep", row: 3, col: 1, minDepth: 2150, maxDepth: 2400, pattern: "FLOAT", speed: 1, weight: [1, 3] },
  ...
  { id: "pirate_skull", name: "Jolly Roger", score: 150, sheet: "deep", row: 3, col: 0, minDepth: 2200, maxDepth: 2400, pattern: "FLOAT", speed: 0.5, weight: [1, 2] },
  { id: "dino", name: "Rex Skull", score: 200, sheet: "void", row: 0, col: 0, minDepth: 2200, maxDepth: 2400, pattern: "SINE", speed: 1, weight: [500, 1e3] },
  // --- MAGMA CORE (2400-2700m) ---
  { id: "ember", name: "Fire Fish", score: 130, sheet: "void", row: 0, col: 1, minDepth: 2400, maxDepth: 2700, pattern: "DART", speed: 6, weight: [2, 8] },
  { id: "dragon", name: "Sea Dragon", score: 150, sheet: "void", row: 0, col: 2, minDepth: 2450, maxDepth: 2700, pattern: "SINE", speed: 2, weight: [50, 200] },
  { id: "rock", name: "Obsidian", score: 40, sheet: "void", row: 0, col: 3, minDepth: 2400, maxDepth: 2700, pattern: "FLOAT", speed: 0, weight: [50, 100] },
  { id: "cooked", name: "Dinner", score: 200, sheet: "void", row: 0, col: 1, minDepth: 2500, maxDepth: 2700, pattern: "FLOAT", speed: 0.5, weight: [0.5, 1] },
  // --- FROZEN DEEP (2700-3000m) ---
  { id: "ice", name: "Ice Cube", score: 90, sheet: "void", row: 1, col: 0, minDepth: 2700, maxDepth: 3e3, pattern: "FLOAT", speed: 0.5, weight: [10, 20] },
  { id: "penguin", name: "Lost Pingu", score: 200, sheet: "void", row: 1, col: 1, minDepth: 2750, maxDepth: 3e3, pattern: "DART", speed: 4, weight: [5, 15] },
  { id: "yeti", name: "Yeti Crab", score: 210, sheet: "void", row: 1, col: 2, minDepth: 2800, maxDepth: 3e3, pattern: "FLOAT", speed: 1, weight: [2, 5] },
  { id: "pizza", name: "Frozen Pizza", score: 150, sheet: "void", row: 1, col: 0, minDepth: 2900, maxDepth: 3e3, pattern: "FLOAT", speed: 0, weight: [0.5, 0.5] },
  // --- THE ETHER (3000-3500m) ---
  { id: "spirit", name: "Wisp", score: 180, sheet: "void", row: 1, col: 3, minDepth: 3e3, maxDepth: 3500, pattern: "SINE", speed: 2, weight: [0, 0] },
  { id: "angel", name: "Seraphim", score: 333, sheet: "void", row: 2, col: 0, minDepth: 3100, maxDepth: 3500, pattern: "FLOAT", speed: 1, weight: [1, 7] },
  { id: "cloud", name: "Nimbus", score: 250, emoji: "☁️", minDepth: 3e3, maxDepth: 3500, pattern: "FLOAT", speed: 0.5, weight: [0, 0] },
  { id: "harp", name: "Angel Harp", score: 300, sheet: "void", row: 2, col: 0, minDepth: 3200, maxDepth: 3500, pattern: "SINE", speed: 1.5, weight: [5, 10] },
  // --- VOID (3500-4000m) ---
  { id: "glitch", name: "MISSINGNO", score: 150, sheet: "void", row: 2, col: 1, minDepth: 3500, maxDepth: 4e3, pattern: "GLITCH", speed: 6, weight: [0, 999.9] },
  { id: "eye", name: "Watcher", score: 120, sheet: "void", row: 2, col: 2, minDepth: 3500, maxDepth: 4e3, pattern: "FLOAT", speed: 0.5, weight: [10, 50] },
  { id: "alien", name: "Invader", score: 140, sheet: "void", row: 2, col: 3, minDepth: 3600, maxDepth: 4e3, pattern: "GLITCH", speed: 5, weight: [40, 80] },
  { id: "dna", name: "Origin", score: 200, sheet: "void", row: 3, col: 0, minDepth: 3700, maxDepth: 4e3, pattern: "SINE", speed: 3, weight: [1e-3, 2e-3] },
  { id: "blackhole", name: "Singularity", score: 500, sheet: "void", row: 3, col: 1, minDepth: 3800, maxDepth: 4e3, pattern: "FLOAT", speed: 0.1, weight: [9999, 9999] },
  { id: "null", name: "NULL", score: 0, sheet: "void", row: 3, col: 2, minDepth: 3500, maxDepth: 4e3, pattern: "GLITCH", speed: 10, weight: [0, 0] },
  { id: "undef", name: "undefined", score: 404, sheet: "void", row: 3, col: 3, minDepth: 3600, maxDepth: 4e3, pattern: "GLITCH", speed: 8, weight: [404, 404] },
  // --- LEGENDARIES (Universal/Abyss) ---
  { id: "goldboot", name: "Golden Boot", score: 500, sheet: "surface", row: 0, col: 0, minDepth: 0, maxDepth: 4e3, pattern: "DART", speed: 4, weight: [10, 10], legendary: true },
  { id: "cybershark", name: "Cyber Shark", score: 1e3, sheet: "deep", row: 2, col: 0, minDepth: 1800, maxDepth: 2100, pattern: "GLITCH", speed: 5, weight: [500, 1e3], legendary: true },
  { id: "kraken", name: "Lil Kraken", score: 800, sheet: "void", row: 2, col: 2, minDepth: 3500, maxDepth: 4e3, pattern: "SINE", speed: 3, weight: [200, 500], legendary: true }
];
const SHOP_ITEMS = [
  // --- LURES (High Contrast) ---
...
const CrazyFishing = () => {
  ...
  const [equippedBobber, setEquippedBobber] = reactExports.useState("lure_neon");
  ...
  const sheetRefs = reactExports.useRef({
    surface: null,
    coral: null,
    deep: null,
    void: null
  ...
  reactExports.useEffect(() => {
    ...
    try {
      const savedSkin = localStorage.getItem("fishingSkin");
  ...
  const buyItem = (item) => {
    const category = item.type === "skin" ? "fishing_boat" : item.type === "bobber" ? "fishing_bobber" : "fishing_misc";
  ...
  const drawGame = (ctx, mode, state) => {
    ...
    const drawFish = (ctx2, fish, x, y, size = 50) => {
      if (fish.sheet && sheetRefs.current[fish.sheet]) {
        ...
        ctx2.drawImage(sheetRefs.current[fish.sheet], sx, sy, sSizeX, sSizeY, x - size / 2, y - size / 2, size, size);
      } else {
        ctx2.fillText(fish.emoji || "❓", x, y);
      }
    };
    const currentBiome = BIOMES.find((b) => state.depth <= b.maxDepth) || BIOMES[0];
