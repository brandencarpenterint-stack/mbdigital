import { r as reactExports, a as useRetroSound, u as useGamification, j as jsxRuntimeExports, S as SquishyButton, L as Link } from "./index-HnrdNYLo.js";
import { U as UniversalGameOver } from "./UniversalGameOver-B5T1U7cB.js";
import { feedService } from "./feed-4jpFbd4y.js";
const BIOMES = [
  { name: "STREETS", limit: 3e3, bgTop: "#87CEEB", bgBot: "#E0F7FA", plat: "#999", text: "#333", border: "#666" },
  { name: "SUNSET WAVE", limit: 6e3, bgTop: "#ff7e5f", bgBot: "#feb47b", plat: "#554433", text: "white", border: "#332211" },
  { name: "TOXIC WASTE", limit: 9e3, bgTop: "#4b1", bgBot: "#260", plat: "#3f3", text: "#cbff00", border: "#252" },
  { name: "CYBER CITY", limit: 12e3, bgTop: "#2b1055", bgBot: "#7597de", plat: "#00ffaa", text: "#00ffaa", border: "white" },
  { name: "ICE AGE", limit: 15e3, bgTop: "#00d2ff", bgBot: "#3a7bd5", plat: "#e0ffff", text: "#caf0f8", border: "#90e0ef" },
  { name: "VOLCANO", limit: 18e3, bgTop: "#800000", bgBot: "#ff0000", plat: "#300", text: "#ff4500", border: "#ffaa00" },
  { name: "CANDY LAND", limit: 21e3, bgTop: "#ffb6c1", bgBot: "#ff69b4", plat: "#ff1493", text: "#fff", border: "#fff" },
  { name: "GLITCH REALM", limit: 24e3, bgTop: "#000000", bgBot: "#111111", plat: "#00ff00", text: "#00ff00", border: "lime", glitch: true },
  { name: "MIDNIGHT TOKYO", limit: 28e3, bgTop: "#0f0c29", bgBot: "#302b63", plat: "#ff00cc", text: "#00d4ff", border: "#ff00cc" },
  { name: "DEEP SPACE", limit: 32e3, bgTop: "#000011", bgBot: "#000033", plat: "#888", text: "#ccc", border: "#444" },
  { name: "STRATOSPHERE", limit: 36e3, bgTop: "#000046", bgBot: "#1CB5E0", plat: "#fff", text: "#fff", border: "#aaa" },
  { name: "THE VOID", limit: 4e4, bgTop: "#1a0033", bgBot: "#000", plat: "#5500ff", text: "#aa00ff", border: "#ff0055" },
...
const MerchJump = () => {
  ...
  const { updateStat, addCoins, coins, spendCoins, userProfile, stats } = useGamification() || {};
  const GRAVITY = 0.4;
  const JUMP_FORCE = -12;
  const WIDTH = 400;
  const HEIGHT = 600;
  ...
  const generatePlatform = (y, biome) => {
    ...
    let type = "normal";
    if (score2 > 4e3 && Math.random() > 0.7) type = "moving";
    if (score2 > 8e3 && Math.random() > 0.8) type = "crumble";
    ...
    if (score2 > 12e3 && Math.random() > 0.8) {
  ...
  const gameLoop = () => {
    ...
    platformsRef.current.forEach((p) => {
      if (p.type === "shrinking") {
        p.w = Math.max(10, p.w - 0.2);
      }
      ctx.fillStyle = p.color || currentBiome.plat;
      if (p.type === "crumble") ctx.fillStyle = "#A0522D";
      if (p.type === "slippery") ctx.fillStyle = "#b0e0e6";
      if (p.type === "melting") ctx.fillStyle = "#ff4500";
      if (p.type === "shrinking") ctx.fillStyle = "#8a2be2";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "merch-jump-container", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-wrapper", style: { position: "relative" }, children: [
        ...
        gameState !== "PLAYING" && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: gameState === "GAMEOVER" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "game-overlay", style: { position: "absolute", inset: 0, borderRadius: "10px", overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          UniversalGameOver,
          {
            gameName: "MERCH JUMP",
        ...
        ) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-overlay", style: { position: "absolute", inset: 0, background: "rgba(255,255,255,0.9)", backdropFilter: "blur(5px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "#333", borderRadius: "10px" }, children: [
