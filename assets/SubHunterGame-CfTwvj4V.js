const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-DdEgTucp.js","assets/index-CqcTHaYE.js","assets/index-CvR-T87U.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, D as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-CqcTHaYE.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-DdEgTucp.js");
