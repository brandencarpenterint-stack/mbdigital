import { u as useSquad, a as usePocketBro, b as useGamification, r as reactExports, j as jsxRuntimeExports, L as Link } from "./index-Cs7M0TxU.js";
import { L as LiveFeed } from "./LiveFeed-ClwC8Oo4.js";
import "./feed-DdKx4sTE.js";
const Home = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-container", style: { maxWidth: "1200px", margin: "0 auto", padding: "20px", paddingBottom: "120px" }, children: [
    ...
    (() => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { style: { margin: 0, color: currentEvent.color, textTransform: "uppercase" }, children: [
            "GLOBAL ALERT: ",
            currentEvent.name
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.9rem", color: "#ddd" }, children: currentEvent.description })
        ] })
      ] });
    })(),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dashboard-grid", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/hustle", className: "bento-card", style: {
        textDecoration: "none",
        color: "white",
        padding: "25px",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { margin: 0, color: "#f0f0f0" }, children: "HUSTLE MODE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.7rem", color: "#888", marginTop: "5px", fontWeight: "bold" }, children: "LO-FI FOCUS TIMER" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { alignSelf: "flex-end", fontSize: "3rem", filter: "drop-shadow(0 0 10px rgba(255,255,255,0.2))" }, children: "⏱️" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/coloring", className: "bento-card", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { zIndex: 1, color: "#333" }, children: "COLORING BOOK" }),
