const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-CP6APWlp.js","assets/index-BYxwzLpI.js","assets/index-CvR-T87U.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-BYxwzLpI.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-CP6APWlp.js");
