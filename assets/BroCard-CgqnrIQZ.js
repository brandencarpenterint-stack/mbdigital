import { a as useGamification, r as reactExports, j as jsxRuntimeExports, m as motion, f as ACHIEVEMENTS } from "./index-BF7Bb9kP.js";
...
import { u as useSpring } from "./use-spring-Be0aE3kB.js";
const BroCard = () => {
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, padding: "70px 30px 30px 30px", textAlign: "center", zIndex: 2, background: "linear-gradient(180deg, #111 0%, #080808 100%)" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "20px", textAlign: "left" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: labelStyle, children: "ACHIEVEMENTS & BADGES" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                    display: "grid",
                    ...
                    borderRadius: "8px"
                  }, children: ACHIEVEMENTS.sort((a, b) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { title: `${ach.title}: ${ach.description} (Reward: ${ach.reward})`, style: {
                      aspectRatio: "1/1",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.2rem", filter: isUnlocked ? "none" : "grayscale(100%) blur(1px)" }, children: isUnlocked ? "🏆" : "🔒" }),
                      isUnlocked && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.4rem", color: "gold", marginTop: "2px", fontWeight: "bold" }, children: "500 XP" })
                    ] }, ach.id);
                  }) })
                ] }),
