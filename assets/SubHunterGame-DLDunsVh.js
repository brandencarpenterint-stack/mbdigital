const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-CX2FOQSY.js","assets/index-CG30FPka.js","assets/index-BDvmBGas.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, a as useGamification, D as useInventory, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-CG30FPka.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-CX2FOQSY.js");
