import { r as reactExports, j as jsxRuntimeExports, a as useGamification, L as Link, m as motion, S as SquishyButton } from "./index-BF7Bb9kP.js";
...
const BeatLab = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-panel", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: 10, right: 10 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        const trackName = prompt("Name your masterpiece:");
        if (trackName) {
          const uploads = JSON.parse(localStorage.getItem("beatlab_uploads") || "[]");
          uploads.push({ name: trackName, data: activeTracks, date: (/* @__PURE__ */ new Date()).toISOString() });
          localStorage.setItem("beatlab_uploads", JSON.stringify(uploads));
          alert("UPLOADED TO PIRATE RADIO 🏴‍☠️");
        }
      }, style: { background: "#333", color: "#fff", border: "1px solid #555", borderRadius: "4px", cursor: "pointer", fontSize: "0.6rem", padding: "5px" }, children: "📡 UPLOAD" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "center", gap: "20px", alignItems: "center", flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SquishyButton,
          {
            onClick: togglePlay,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "5px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              children: BANKS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: b.id, disabled: b.locked, children: [
                b.locked ? "🔒 " : "",
                b.name
              ] }, b.id))
            }
