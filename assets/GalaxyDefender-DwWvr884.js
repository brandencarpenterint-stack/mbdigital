import { a as useGamification, r as reactExports, b as useRetroSound, j as jsxRuntimeExports, S as SquishyButton, L as Link, t as triggerConfetti } from "./index-Dn0DtKAx.js";
  ...
  const gameLoop = (timestamp) => {
    ...
    if (state.invincible % 10 < 5) {
      ...
      if (state.hasShield) {
        ...
        ctx.lineWidth = 2;
        ctx.beginPath();
        ctx.arc(playerXDraw + PLAYER_SIZE / 2, playerYDraw + PLAYER_SIZE / 2, 35, 0, Math.PI * 2);
        ctx.stroke();
      }
      ctx.restore();
    }
