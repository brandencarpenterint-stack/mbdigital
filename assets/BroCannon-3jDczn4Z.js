import { z as useNavigate, c as useRetroSound, r as reactExports, b as useGamification, j as jsxRuntimeExports, S as SquishyButton } from "./index-BtL-ywO7.js";
const GRAVITY = 0.4;
const DRAG = 0.995;
const GROUND_Y = 0;
const BroCannon = () => {
  ...
  const launch = () => {
    ...
    const upgradeMult = 1 + upgrades.power * 0.1;
  ...
  const update = () => {
    const dragFactor = DRAG + upgrades.aero * 5e-4;
    ...
    if (pos.current.y <= GROUND_Y) {
      ...
      const bounceEff = 0.5 + upgrades.bounce * 0.05;
