const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LeaderboardService-CEYXTLJ-.js","assets/index-HnrdNYLo.js","assets/index-BlbmCFba.css"])))=>i.map(i=>d[i]);
import { B as useNavigate, r as reactExports, u as useGamification, i as useSettings, j as jsxRuntimeExports, _ as __vitePreload } from "./index-HnrdNYLo.js";
const SubHunterGame = () => {
  ...
  const gameOver = () => {
    ...
    __vitePreload(async () => {
      const { leaderboardService } = await import("./LeaderboardService-CEYXTLJ-.js");
