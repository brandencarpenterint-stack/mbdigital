import { r as reactExports, a as useGamification, j as jsxRuntimeExports } from "./index-BjlAyyZi.js";
import { LeaderboardService } from "./LeaderboardService-BJBOzmet.js";
const LeaderboardTable = ({ gameId }) => {
  ...
  reactExports.useEffect(() => {
    ...
    fetchScores();
    const interval = setInterval(fetchScores, 3e4);
    return () => {
      isMounted = false;
