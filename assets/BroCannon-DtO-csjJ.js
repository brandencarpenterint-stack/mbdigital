import { z as useNavigate, c as useRetroSound, b as useGamification, r as reactExports, j as jsxRuntimeExports, S as SquishyButton } from "./index-CZj-ltfi.js";
const GRAVITY = 0.5;
...
const BroCannon = () => {
  ...
  const [gameState, setGameState] = reactExports.useState("AIM");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", top: 20, left: 20, zIndex: 100 }, children: [
    ...
    gameState === "LANDED" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SquishyButton, { onClick: resetGame, style: { fontSize: "1.5rem", padding: "20px 40px", background: "var(--neon-blue)" }, children: "LAUNCH AGAIN" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      // Instant update for rigid camera
    }, children: [
      ...
      [0, 100, 200, 500, 1e3].map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", left: d * 10, bottom: GROUND_LEVEL - 30, color: "rgba(255,255,255,0.5)", fontSize: "1.5rem" }, children: [
        d,
        "m"
      ] }, d))
    ] })
